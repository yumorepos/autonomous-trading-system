...
if __name__ == '__main__':
    with tempfile.TemporaryDirectory(prefix='openclaw-timeout-') as temp_dir:
        ...
        assert module.EXCHANGE_THRESHOLDS['Polymarket']['take_profit_pct'] == 2.0, module.EXCHANGE_THRESHOLDS
        assert module.EXCHANGE_THRESHOLDS['Hyperliquid']['take_profit_pct'] == 2.0, module.EXCHANGE_THRESHOLDS
